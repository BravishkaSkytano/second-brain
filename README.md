...
- **Rosé Pine:** A Rosé Pine Theme for Obsidian | [GitHub](https://github.com/sspaeti/obsidian_rose_pine)
...
## Plugins I Use (Or Used Too)

- ✨ **Major New Features** ✨
	- ***Callout Manager:*** An Obsidian.md plugin that makes creating and configuring callouts easy | [GitHub](https://github.com/eth-p/obsidian-callout-manager) | [Obsidian](obsidian://show-plugin?id=callout-manager)
	...
	- ~~***Soundscapes:*** A plugin for Obsidian.MD that adds a music/ambiance player to the status bar to play Lofi beats, nature sounds, ambiance, relaxing music, and more | [GitHub](https://github.com/andrewmcgivery/obsidian-soundscapes) | [Obsidian](obsidian://show-plugin?id=soundscapes)~~
...
- 🧰 **Handy Utilities** 🧰
	...
	- ***List Callouts:*** Create callouts in lists in Obsidian | [GitHub](https://github.com/mgmeyers/obsidian-list-callouts) | [Obsidian](obsidian://show-plugin?id=obsidian-list-callouts)
	- ***Note Toolbar:*** Plugin for Obsidian providing a flexible way to create context-aware toolbars for your notes | [GitHub](https://github.com/chrisgurney/obsidian-note-toolbar) | [Obsidian](obsidian://show-plugin?id=note-toolbar)
	...
	- ***Tag Wrangler:*** Rename, merge, toggle, and search tags from the Obsidian tag pane | [GitHub](https://github.com/pjeby/tag-wrangler) | [Obsidian](obsidian://show-plugin?id=tag-wrangler)
...
- ✍️ **Editor Enhancements** ✍️
	...
	- ***LanguageTool Integration:*** languagetool plugin for obsidian | [GitHub](https://github.com/Clemens-E/obsidian-languagetool-plugin) | [Obsidian](obsidian://show-plugin?id=obsidian-languagetool-plugin)
	- ***Media Notes:*** Obsidian plugin that provides best-in-class experience for video note-taking | [GitHub](https://github.com/jemstelos/obsidian-media-notes) | [Obsidian](obsidian://show-plugin?id=media-notes)
	- ***Painter:*** paint text different colors | [GitHub](https://github.com/KraXen72/obsidian-painter) | [Obsidian](obsidian://show-plugin?id=painter)
...
- 🖌️ **Appearance Upgrades** 🖌️
	...
	- ***Beautitab:*** A plugin for Obsidian.MD that creates a customizable new tab view with beautiful backgrounds, quotes, search, and more | [GitHub](https://github.com/andrewmcgivery/obsidian-beautitab) | [Obsidian](obsidian://show-plugin?id=beautitab)
	- ***Colored Tags Wrangler:*** Obsidian Plugin : Assign colors to tags. Has integrations with other plugins, like Kanban | [GitHub](https://github.com/code-of-chaos/obsidian-colored_tags_wrangler) | [Obsidian](obsidian://show-plugin?id=colored-tags-wrangler)
